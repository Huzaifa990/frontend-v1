...
export default function MyProfile() {
  ...
  useEffect(() => {
    async function getData() {
      const response = await fetch("https://move-3dri.onrender.com/api/analytics/lesseeAnalytics", {
    ...
    async function getPersonalInfo() {
      const response = await fetch("https://move-3dri.onrender.com/api/auth/user", {
        headers: { Authorization: userDetails },
      });
  ...
  const sendName = () => {
    ...
    axios
      .put(
        "https://move-3dri.onrender.com/api/auth/updateName",
        {
          updatedName,
        },
        {
  ...
  const updateNumber = () => {
    ...
    axios
      .put(
        "https://move-3dri.onrender.com/api/auth/updatePhoneNumber",
        {
          updatedPhoneNumber,
        },
        {
  ...
  const sendEmail = () => {
    ...
    axios
      .put(
        "https://move-3dri.onrender.com/api/auth/updateEmail",
        {
          updatedEmail,
        },
        {
  ...
  const sendPassword = () => {
    ...
    axios
      .put(
        "https://move-3dri.onrender.com/api/auth/updatePassword",
        {
          password,
          newPassword,
          confirmNewPassword,
  ...
  const sendProfielPicture = () => {
    ...
    axios
      .put(
        "https://move-3dri.onrender.com/api/auth/updatedProfilePic",
        {
          updatedProfilePic,
        },
        {
  ...
  function uploadCnic() {
    ...
    axios
      .put("https://move-3dri.onrender.com/api/auth/uploadCNIC", payload, {
        headers: headers,
      })
      .then((res) => {
        console.log(res);
