...
const SignUp = () => {
  ...
  {
    document.getElementById("signUpbtn").disabled = (!document.getElementById("signUpbtn").disabled);
  }
  ...
  return (
    <div className="signup-form-container">
      ...
      <div class="popuptc-container" id="pop" onClick={toggleOff}>
        ...
        <button className="btn btn-primary py-3 px-5" id="signUpbtn" disabled="true" onClick={sendData}>
          Sign Up
        </button>
        <br /> <br />
